...
namespace Aporia
{
    ...
    public:
        ...
        Container::iterator LayerStack::begin()             { return _layers.begin(); }
        Container::iterator LayerStack::end()               { return _layers.end(); }
        Container::reverse_iterator LayerStack::rbegin()    { return _layers.rbegin(); }
